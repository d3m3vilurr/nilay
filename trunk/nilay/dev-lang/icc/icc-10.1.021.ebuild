...
PB=cc
PEXEC="icc icpc"
DESCRIPTION="Intel C/C++ optimized compiler for Linux(only x86, early ebuild, not official ebuild"
...
SRC_URI="x86?  ( ${SRC_COM}_ia32.tar.gz )"
...
pkg_setup() {
	...
	if use amd64 || use ia64; then
		die "This Ebuild doesn't support any architecture without x86."
		die "Don't cry and wait official ebuild. :P"
	fi
	use x86 && disk_req="500"
