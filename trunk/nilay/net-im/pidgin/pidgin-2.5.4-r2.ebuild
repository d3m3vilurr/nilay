...
# $Header: /var/cvsroot/gentoo-x86/net-im/pidgin/pidgin-2.5.4-r1.ebuild,v 1.1 2009/02/08 13:17:40 drizzt Exp $
...
IUSE="${IUSE} +gtk sasl ncurses groupwise prediction  xscreensaver zephyr" # mono"
...
src_configure() {
	...
	if ! use xscreensaver; then
		myconf="${myconf} --disable-screensaver"
	fi
	if use silc; then
