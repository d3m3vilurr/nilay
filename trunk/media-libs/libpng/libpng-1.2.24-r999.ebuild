...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libpng/libpng-1.2.24.ebuild,v 1.1 2007/12/14 18:50:06 vapier Exp $
...
src_unpack() {
	...
	if use apng; then
		epatch "${FILESDIR}"/${PN}-1.2.24-apng-inserted_by_nidev.patch 
	fi
