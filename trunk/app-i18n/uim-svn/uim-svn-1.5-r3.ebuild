...
src_unpack() {
	...
	cd "${S}"
	#epatch ${FILESDIR}/byeoru_scm-ssang_letter.patch
...
src_install() {
	...
	einfo "These bugs had been fixed:"
	einfo "https://bugs.freedesktop.org/show_bug.cgi?id=13879"
	einfo "https://bugs.freedesktop.org/show_bug.cgi?id=13920"
	einfo "So, If you need, you don't have to use this package."
	einfo "Say again, you can use official portage's ebuild."
	einfo "Thank you!"
