...
src_unpack() {
	if use ecomorph; then
		...
		einfo "------------------------------------------------------"
		elog "After setting up ecomorph, you should start E and load"
		elog "the module named ecomorph from settings -> extesions."
		elog "It can help you to ease your configurating."
		elog "And also don't forget to check Ecomorph mode in that dialog."
		ewarn ""
		ewarn ""
		ewarn "Warning : You've enabled ecomorph flag."
